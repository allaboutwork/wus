...
INNER JOIN enrollment_wus ON course_wus.course_id = enrollment_wus.course_id
WHERE enrollment_wus.course_id = '".$_GET['course_id']."'
AND enrollment_wus.user_id = '".$_SESSION['user_id']."'
";
...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 d-flex justify-content-center">Course <?php echo"$course_name"; ?></h1>
					...
					<div class="card-body">
                        ...
                        AND course_wus.course_id = '".$_GET['course_id']."'
                        ";
                        $result = $object->get_result();
                        ...
                        {
                            $course_name = $row['course_name'];
                            echo"<h6>Course Name: $course_name </h6>"; 
                        ...
                        INNER JOIN enrollment_wus ON enrollment_wus.course_id = material_wus.course_id)
                        WHERE enrollment_wus.user_id =  '".$_SESSION['user_id']."'
                        AND course_wus.course_id = '".$_GET['course_id']."'
                        ";
                        $result = $object->get_result();
                        ...
                        foreach($result as $row)
                        {
                            $material_name = $object->Get_material_name($row['mateial_id']);
                            echo"<h6>material Name: $material_name </h6>"; 
