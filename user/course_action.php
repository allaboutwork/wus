...
//	1.a. Action Fetch Starts
	...
	{
		$order_column = array('course_wus.course_name', 'category_wus.category_name','course_wus.course_description','course_wus.course_status' 
		// , 'course_created_on', 'course_created_by', 'course_updated_on', 'course_updated_by'
		);
		...
		INNER JOIN category_wus
		ON category_wus.category_id = course_wus.category_id 
		";
		...
		if(isset($_POST["search"]["value"]))
		{
			...
			// $search_query .= 'OR course_created_by LIKE "%'.$_POST["search"]["value"].'%" ';
...
//	1.b. Action Fetch for Staff Starts
	if($_POST["action"] == 'fetch-by-staff')
	{
		$order_column = array('course_wus.course_name', 'category_wus.category_name','course_wus.course_description','course_wus.course_status' 
		// , 'course_created_on', 'course_created_by', 'course_updated_on', 'course_updated_by'
		);
	...
	// 1.b	Action Fetch for Staff Ends
