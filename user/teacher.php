...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 d-flex justify-content-center">Teacher Section</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                        	<div class="row">
                                ...
                                <?php
								if($object->is_master_user() || $object->is_teacher_user())
								{
								?>
...
$(document).ready(
	...
	var dataTable = $('#user_table').DataTable({
		...
		"ajax" : {
			url:"teacher_action.php",
			type:"POST",
			data:{action:'fetch_teacher_by_staff'}
		},
		"columnDefs":[
			{
				// "targets":[1, 2, 3, 4, 7, 8],
	...
	$('#add_user').click(
    	...
    	$('#modal_title').text('Add Teacher User');
	...
	$('#user_form').on('submit', function(event){
		...
		{		
			$.ajax({
                // Will send the uploaded data to teacher_action.php
				url:"teacher_action.php",
				method:"POST",
