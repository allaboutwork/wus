...
//	1.b. Action Fetch Starts
	...
	{
		$order_column = array('enrollment_wus.enrollment_id', 'enrollment_wus.course_id','enrollment_wus.user_id', 'enrollment_wus.enrollment_status');
		...
		if(isset($_POST["search"]["value"]))
		{
			$search_query .= 'WHERE enrollment_wus.enrollment_id LIKE "%'.$_POST["search"]["value"].'%" ';
